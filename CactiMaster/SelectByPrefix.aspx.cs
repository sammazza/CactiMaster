...
{
    public partial class SelectByPrefix : System.Web.UI.Page
    {
        public string str = "";
        public string msg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                prefix = Request.QueryString["prefix"].ToString();
            }

            if (prefix.Length == 0 || prefix.Length > 3 || !prefix.All(char.IsDigit))
            {
                msg = "Invalid prefix code";
                return;
            }
            sqlSelect = $"SELECT * FROM {DBHelper.DB_USER_TABLE} ";
            sqlSelect += $" WHERE prefix='{prefix}';";
