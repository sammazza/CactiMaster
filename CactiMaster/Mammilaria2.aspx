<%@ Page Title="" Language="C#" MasterPageFile="~/Cacti.Master" AutoEventWireup="true" CodeBehind="Mammilaria2.aspx.cs" Inherits="CactiMaster.Mammilaria2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="SubHeaderPlaceHolder" runat="server">
        <h1 style="color: darkorange; text-align: center;">Mammilaria</h1>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 style="color: darkorange; text-align: center;">Mammilaria Cirrhfera</h2>
    <img src="Images/mammillaria_cirrhfera.jpg" alt="mammillaria_cirrhfera" title="Mammillaria Cirrhfera" style="float: left; margin: 10px;" />
    <h3>General</h3>
    <p>
